...
python3 pan_policy_analyzer -file filename.xml -type firewall|panorama -list vsys|devicegroup

Analyze all:
python3 pan_policy_analyzer -file filename.xml -type firewall|panorama
